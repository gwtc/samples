...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['IMRPhenomPv2NRT_highSpin_posterior'] = ['luminosity_distance', 'ra', 'dec', 'mass_1', 'mass_2', 'a_1', 'a_2', 'theta_jn', 'tilt_1', 'tilt_2', 'mass_ratio', 'total_mass', 'chirp_mass', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'chi_eff', 'chi_p', 'redshift'];
    list['IMRPhenomPv2NRT_lowSpin_posterior'] = ['luminosity_distance', 'ra', 'dec', 'mass_1', 'mass_2', 'a_1', 'a_2', 'theta_jn', 'tilt_1', 'tilt_2', 'mass_ratio', 'total_mass', 'chirp_mass', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'chi_eff', 'chi_p', 'redshift'];
    ...
    var data = {}
    data['IMRPhenomPv2NRT_highSpin_posterior'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['IMRPhenomPv2NRT_lowSpin_posterior'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
