...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['mass_1', 'mass_1_source', 'mass_2_source', 'luminosity_distance', 'chi_p', 'phi_12', 'geocent_time', 'total_mass_source', 'psi', 'theta_jn', 'a_2', 'ra', 'chirp_mass_source', 'mass_ratio', 'dec', 'a_1', 'phase', 'tilt_1', 'chirp_mass', 'mass_2', 'tilt_2', 'total_mass', 'chi_eff', 'phi_jl', 'redshift'];
