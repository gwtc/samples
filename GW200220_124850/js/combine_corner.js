...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_ratio', 'phi_jl', 'geocent_time', 'theta_jn', 'chi_p', 'chirp_mass_source', 'phase', 'mass_1', 'a_1', 'mass_2', 'phi_12', 'mass_2_source', 'mass_1_source', 'ra', 'dec', 'chirp_mass', 'tilt_1', 'total_mass_source', 'psi', 'luminosity_distance', 'total_mass', 'a_2', 'chi_eff', 'tilt_2', 'redshift'];
