...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['phi_jl', 'ra', 'geocent_time', 'phi_12', 'mass_1_source', 'psi', 'total_mass_source', 'tilt_2', 'chi_eff', 'chirp_mass_source', 'mass_1', 'total_mass', 'a_1', 'theta_jn', 'tilt_1', 'luminosity_distance', 'chi_p', 'chirp_mass', 'a_2', 'dec', 'phase', 'mass_ratio', 'mass_2', 'mass_2_source', 'redshift'];
