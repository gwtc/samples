...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['phi_12', 'phase', 'chirp_mass', 'total_mass_source', 'mass_2', 'tilt_1', 'a_1', 'chirp_mass_source', 'chi_eff', 'mass_2_source', 'a_2', 'geocent_time', 'luminosity_distance', 'theta_jn', 'mass_1_source', 'tilt_2', 'psi', 'dec', 'mass_1', 'chi_p', 'mass_ratio', 'ra', 'total_mass', 'phi_jl', 'redshift'];
