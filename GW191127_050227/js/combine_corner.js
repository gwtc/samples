...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['ra', 'chi_eff', 'geocent_time', 'phase', 'total_mass', 'dec', 'a_2', 'mass_2_source', 'psi', 'mass_1_source', 'mass_1', 'mass_ratio', 'phi_jl', 'chi_p', 'tilt_1', 'theta_jn', 'phi_12', 'luminosity_distance', 'a_1', 'chirp_mass_source', 'tilt_2', 'mass_2', 'chirp_mass', 'total_mass_source', 'redshift'];
