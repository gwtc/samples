...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['a_2', 'phi_jl', 'chirp_mass', 'psi', 'ra', 'chi_eff', 'mass_1', 'geocent_time', 'chirp_mass_source', 'mass_2_source', 'phi_12', 'mass_1_source', 'tilt_1', 'mass_ratio', 'total_mass', 'chi_p', 'dec', 'luminosity_distance', 'a_1', 'phase', 'total_mass_source', 'theta_jn', 'mass_2', 'tilt_2', 'redshift'];
