...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['chi_eff', 'phase', 'a_1', 'mass_1', 'total_mass_source', 'chirp_mass', 'tilt_2', 'total_mass', 'phi_12', 'phi_jl', 'chi_p', 'ra', 'psi', 'mass_2_source', 'chirp_mass_source', 'mass_2', 'geocent_time', 'a_2', 'luminosity_distance', 'mass_ratio', 'dec', 'tilt_1', 'theta_jn', 'mass_1_source', 'redshift'];
