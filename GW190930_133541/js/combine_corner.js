...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['chirp_mass', 'mass_1_source', 'phase', 'mass_1', 'tilt_1', 'theta_jn', 'a_1', 'phi_12', 'phi_jl', 'mass_2_source', 'mass_2', 'a_2', 'ra', 'total_mass_source', 'geocent_time', 'chi_p', 'luminosity_distance', 'psi', 'mass_ratio', 'chi_eff', 'tilt_2', 'dec', 'total_mass', 'chirp_mass_source', 'redshift'];
