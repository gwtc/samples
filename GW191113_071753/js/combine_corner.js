...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['dec', 'phi_jl', 'mass_2', 'geocent_time', 'psi', 'total_mass_source', 'mass_2_source', 'luminosity_distance', 'chi_eff', 'total_mass', 'a_2', 'mass_1_source', 'tilt_2', 'ra', 'theta_jn', 'chi_p', 'chirp_mass_source', 'tilt_1', 'a_1', 'phi_12', 'phase', 'mass_1', 'chirp_mass', 'mass_ratio', 'redshift'];
