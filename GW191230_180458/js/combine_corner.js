...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'tilt_1', 'geocent_time', 'a_1', 'chirp_mass', 'luminosity_distance', 'phi_12', 'theta_jn', 'chi_eff', 'tilt_2', 'mass_2', 'chirp_mass_source', 'ra', 'chi_p', 'phase', 'mass_2_source', 'phi_jl', 'mass_ratio', 'mass_1_source', 'mass_1', 'dec', 'psi', 'a_2', 'total_mass', 'redshift'];
