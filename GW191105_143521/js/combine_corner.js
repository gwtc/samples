...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['tilt_2', 'mass_2_source', 'phi_jl', 'geocent_time', 'phase', 'chi_p', 'mass_ratio', 'tilt_1', 'total_mass', 'chi_eff', 'a_2', 'psi', 'dec', 'mass_1_source', 'ra', 'chirp_mass_source', 'phi_12', 'luminosity_distance', 'mass_2', 'chirp_mass', 'mass_1', 'theta_jn', 'a_1', 'total_mass_source', 'redshift'];
