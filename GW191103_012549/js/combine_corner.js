...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['chi_eff', 'total_mass', 'phi_jl', 'phi_12', 'mass_2', 'luminosity_distance', 'total_mass_source', 'phase', 'mass_ratio', 'chirp_mass', 'chirp_mass_source', 'chi_p', 'mass_1_source', 'a_2', 'theta_jn', 'ra', 'mass_2_source', 'dec', 'mass_1', 'psi', 'a_1', 'tilt_2', 'geocent_time', 'tilt_1', 'redshift'];
