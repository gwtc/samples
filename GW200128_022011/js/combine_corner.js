...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['tilt_2', 'mass_2', 'tilt_1', 'mass_1', 'dec', 'psi', 'phase', 'phi_12', 'ra', 'chi_p', 'chirp_mass_source', 'mass_ratio', 'luminosity_distance', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'theta_jn', 'geocent_time', 'a_1', 'chi_eff', 'a_2', 'chirp_mass', 'phi_jl', 'total_mass', 'redshift'];
