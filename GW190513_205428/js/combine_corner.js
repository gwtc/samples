...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'mass_ratio', 'chi_eff', 'phi_12', 'chirp_mass', 'tilt_2', 'mass_2_source', 'theta_jn', 'phi_jl', 'geocent_time', 'chi_p', 'mass_1_source', 'total_mass', 'tilt_1', 'chirp_mass_source', 'a_2', 'phase', 'dec', 'mass_1', 'luminosity_distance', 'ra', 'a_1', 'psi', 'mass_2', 'redshift'];
