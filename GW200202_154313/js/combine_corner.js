...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['theta_jn', 'phase', 'chirp_mass_source', 'psi', 'chirp_mass', 'a_1', 'phi_12', 'ra', 'tilt_2', 'mass_1_source', 'chi_eff', 'mass_ratio', 'phi_jl', 'total_mass_source', 'mass_2', 'a_2', 'dec', 'geocent_time', 'chi_p', 'luminosity_distance', 'mass_2_source', 'total_mass', 'mass_1', 'tilt_1', 'redshift'];
