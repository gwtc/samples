...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['theta_jn', 'phi_12', 'mass_2', 'phase', 'mass_1', 'ra', 'tilt_2', 'tilt_1', 'mass_1_source', 'chirp_mass_source', 'psi', 'a_2', 'mass_2_source', 'geocent_time', 'phi_jl', 'chi_eff', 'mass_ratio', 'luminosity_distance', 'chirp_mass', 'total_mass_source', 'chi_p', 'a_1', 'total_mass', 'dec', 'redshift'];
