...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['tilt_2', 'tilt_1', 'dec', 'phase', 'mass_1', 'total_mass', 'mass_2', 'mass_2_source', 'phi_jl', 'ra', 'chi_p', 'phi_12', 'mass_1_source', 'chi_eff', 'psi', 'luminosity_distance', 'geocent_time', 'chirp_mass', 'theta_jn', 'a_2', 'mass_ratio', 'a_1', 'chirp_mass_source', 'total_mass_source', 'redshift'];
