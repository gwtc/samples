...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_1', 'a_2', 'total_mass_source', 'luminosity_distance', 'dec', 'phase', 'chirp_mass', 'chi_eff', 'phi_12', 'chi_p', 'phi_jl', 'chirp_mass_source', 'mass_2', 'tilt_1', 'mass_1_source', 'geocent_time', 'theta_jn', 'tilt_2', 'ra', 'psi', 'mass_2_source', 'a_1', 'total_mass', 'mass_ratio', 'redshift'];
