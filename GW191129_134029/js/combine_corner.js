...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['chirp_mass_source', 'dec', 'geocent_time', 'phase', 'a_2', 'a_1', 'chi_eff', 'mass_ratio', 'chi_p', 'luminosity_distance', 'ra', 'mass_2', 'phi_jl', 'total_mass_source', 'tilt_1', 'tilt_2', 'psi', 'phi_12', 'mass_2_source', 'total_mass', 'mass_1', 'chirp_mass', 'theta_jn', 'mass_1_source', 'redshift'];
