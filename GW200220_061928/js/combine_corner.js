...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_1', 'phi_12', 'tilt_2', 'chi_eff', 'mass_1_source', 'mass_ratio', 'ra', 'chirp_mass_source', 'total_mass_source', 'chirp_mass', 'psi', 'theta_jn', 'geocent_time', 'dec', 'phi_jl', 'luminosity_distance', 'total_mass', 'tilt_1', 'chi_p', 'a_1', 'a_2', 'mass_2_source', 'mass_2', 'phase', 'redshift'];
