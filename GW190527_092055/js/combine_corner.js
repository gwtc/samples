...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['ra', 'phi_jl', 'a_2', 'tilt_1', 'mass_ratio', 'chirp_mass_source', 'tilt_2', 'total_mass', 'theta_jn', 'mass_2_source', 'chi_eff', 'luminosity_distance', 'total_mass_source', 'dec', 'mass_2', 'a_1', 'mass_1_source', 'chirp_mass', 'chi_p', 'phase', 'geocent_time', 'phi_12', 'mass_1', 'psi', 'redshift'];
