...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['psi', 'ra', 'mass_ratio', 'dec', 'total_mass', 'mass_1_source', 'chirp_mass', 'chi_eff', 'a_1', 'geocent_time', 'phase', 'mass_1', 'tilt_1', 'theta_jn', 'luminosity_distance', 'tilt_2', 'a_2', 'phi_jl', 'chirp_mass_source', 'mass_2', 'chi_p', 'total_mass_source', 'mass_2_source', 'phi_12', 'redshift'];
