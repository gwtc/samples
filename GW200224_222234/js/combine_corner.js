...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_1_source', 'chi_p', 'chirp_mass', 'chirp_mass_source', 'total_mass', 'geocent_time', 'luminosity_distance', 'theta_jn', 'chi_eff', 'a_1', 'total_mass_source', 'phi_jl', 'mass_2', 'ra', 'tilt_2', 'tilt_1', 'psi', 'dec', 'mass_2_source', 'phi_12', 'mass_ratio', 'phase', 'a_2', 'mass_1', 'redshift'];
