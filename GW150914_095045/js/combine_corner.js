...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['dec', 'chirp_mass', 'theta_jn', 'ra', 'a_1', 'mass_1_source', 'geocent_time', 'mass_2', 'chi_eff', 'mass_2_source', 'phi_12', 'phase', 'a_2', 'chirp_mass_source', 'mass_ratio', 'total_mass', 'mass_1', 'total_mass_source', 'chi_p', 'tilt_1', 'tilt_2', 'luminosity_distance', 'phi_jl', 'psi', 'redshift'];
