...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'mass_1_source', 'dec', 'chirp_mass', 'phi_jl', 'mass_ratio', 'tilt_1', 'chirp_mass_source', 'chi_p', 'psi', 'luminosity_distance', 'mass_2', 'mass_2_source', 'geocent_time', 'a_1', 'chi_eff', 'tilt_2', 'mass_1', 'phase', 'theta_jn', 'total_mass', 'phi_12', 'a_2', 'ra', 'redshift'];
    list['C01:IMRPhenomXPHM'] = ['phase', 'phi_12', 'phi_jl', 'mass_ratio', 'geocent_time', 'ra', 'dec', 'luminosity_distance', 'psi', 'chirp_mass', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'theta_jn', 'mass_1', 'mass_2', 'total_mass', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'chi_eff', 'chi_p', 'redshift'];
