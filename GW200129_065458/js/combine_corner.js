...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['luminosity_distance', 'total_mass', 'phi_jl', 'dec', 'tilt_1', 'chi_eff', 'chirp_mass', 'mass_1_source', 'a_2', 'psi', 'tilt_2', 'mass_2_source', 'mass_ratio', 'theta_jn', 'total_mass_source', 'mass_1', 'a_1', 'chirp_mass_source', 'mass_2', 'geocent_time', 'chi_p', 'ra', 'phi_12', 'phase', 'redshift'];
