...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['phi_12', 'phase', 'theta_jn', 'phi_jl', 'chirp_mass_source', 'tilt_1', 'mass_1', 'total_mass_source', 'chi_eff', 'geocent_time', 'tilt_2', 'total_mass', 'chirp_mass', 'a_2', 'a_1', 'mass_1_source', 'dec', 'psi', 'chi_p', 'mass_2_source', 'ra', 'luminosity_distance', 'mass_2', 'mass_ratio', 'redshift'];
