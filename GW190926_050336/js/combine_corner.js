...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['mass_ratio', 'a_2', 'phi_jl', 'chirp_mass', 'total_mass_source', 'ra', 'phi_12', 'phase', 'mass_1_source', 'mass_2_source', 'mass_1', 'chi_p', 'theta_jn', 'chi_eff', 'chirp_mass_source', 'psi', 'dec', 'mass_2', 'luminosity_distance', 'a_1', 'geocent_time', 'tilt_2', 'tilt_1', 'total_mass', 'redshift'];
