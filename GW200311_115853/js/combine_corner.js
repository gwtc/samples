...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['luminosity_distance', 'total_mass', 'total_mass_source', 'mass_2_source', 'mass_ratio', 'mass_1_source', 'phase', 'dec', 'chi_eff', 'tilt_1', 'phi_12', 'ra', 'chirp_mass_source', 'theta_jn', 'geocent_time', 'psi', 'chirp_mass', 'a_1', 'mass_1', 'a_2', 'mass_2', 'chi_p', 'tilt_2', 'phi_jl', 'redshift'];
