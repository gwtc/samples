...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['luminosity_distance', 'theta_jn', 'phi_jl', 'total_mass', 'chirp_mass', 'total_mass_source', 'phase', 'tilt_1', 'chi_p', 'a_1', 'ra', 'mass_1', 'mass_ratio', 'phi_12', 'mass_1_source', 'geocent_time', 'psi', 'mass_2_source', 'tilt_2', 'dec', 'a_2', 'chi_eff', 'mass_2', 'chirp_mass_source', 'redshift'];
