...
function grab_html(param, label="None") {
    ...
    */
    ...
    if ( label == "switch") {
        ...
        if ( param == "C01:IMRPhenomNSBH:HighSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:IMRPhenomNSBH:LowSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:IMRPhenomXPHM:HighSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:IMRPhenomXPHM:LowSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:Mixed" ) {
            approx = "None" 
        }
        if ( param == "C01:Mixed:NSBH:HighSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:Mixed:NSBH:LowSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:SEOBNRv4PHM" ) {
            approx = "None" 
        }
        if ( param == "C01:SEOBNRv4_ROM_NRTidalv2_NSBH:HighSpin" ) {
            approx = "None" 
        }
        if ( param == "C01:SEOBNRv4_ROM_NRTidalv2_NSBH:LowSpin" ) {
            approx = "None" 
        }
