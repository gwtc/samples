...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_2', 'dec', 'mass_2_source', 'phase', 'geocent_time', 'mass_ratio', 'theta_jn', 'chirp_mass', 'psi', 'a_1', 'phi_jl', 'a_2', 'mass_1', 'ra', 'luminosity_distance', 'chirp_mass_source', 'mass_1_source', 'chi_eff', 'total_mass', 'chi_p', 'tilt_1', 'tilt_2', 'total_mass_source', 'phi_12', 'redshift'];
