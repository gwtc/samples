...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:SEOBNRv4PHM'] = ['mass_1', 'mass_2', 'chirp_mass', 'ra', 'dec', 'phase', 'psi', 'luminosity_distance', 'total_mass', 'mass_ratio', 'chi_eff', 'chi_p', 'tilt_1', 'tilt_2', 'phi_12', 'theta_jn', 'phi_jl', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'a_1', 'a_2', 'redshift'];
    list['C01:Mixed'] = ['chirp_mass', 'chi_p', 'tilt_1', 'dec', 'mass_1', 'mass_2', 'chi_eff', 'total_mass', 'mass_ratio', 'psi', 'phi_jl', 'phi_12', 'total_mass_source', 'theta_jn', 'a_1', 'phase', 'ra', 'mass_2_source', 'luminosity_distance', 'a_2', 'chirp_mass_source', 'tilt_2', 'mass_1_source', 'redshift'];
    list['C01:IMRPhenomXPHM'] = ['luminosity_distance', 'geocent_time', 'chirp_mass', 'mass_ratio', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'ra', 'dec', 'total_mass', 'mass_1', 'mass_2', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'redshift'];
    ...
    var data = {}
    data['C01:SEOBNRv4PHM'] = {'width': 200.0, 'height': 200.0, 'seperation': 10.000000000000028, 'x0': 100.00000000000003, 'y0': 100.00000000000003};
    data['C01:Mixed'] = {'width': 200.0, 'height': 200.0, 'seperation': 10.000000000000028, 'x0': 100.00000000000003, 'y0': 100.00000000000003};
