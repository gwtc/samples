...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['phi_jl', 'mass_1_source', 'theta_jn', 'phase', 'ra', 'mass_ratio', 'chirp_mass_source', 'a_1', 'mass_2', 'total_mass_source', 'chi_p', 'luminosity_distance', 'tilt_1', 'phi_12', 'mass_2_source', 'psi', 'tilt_2', 'chi_eff', 'a_2', 'chirp_mass', 'geocent_time', 'mass_1', 'dec', 'total_mass', 'redshift'];
