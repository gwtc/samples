...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['ra', 'psi', 'theta_jn', 'phase', 'total_mass', 'luminosity_distance', 'mass_2', 'dec', 'tilt_1', 'mass_ratio', 'phi_jl', 'geocent_time', 'phi_12', 'a_1', 'chi_eff', 'mass_2_source', 'a_2', 'total_mass_source', 'chi_p', 'tilt_2', 'mass_1', 'chirp_mass', 'chirp_mass_source', 'mass_1_source', 'redshift'];
