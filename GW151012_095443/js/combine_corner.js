...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['psi', 'luminosity_distance', 'phase', 'chirp_mass', 'total_mass_source', 'chi_p', 'tilt_2', 'mass_2', 'theta_jn', 'a_1', 'dec', 'mass_2_source', 'geocent_time', 'total_mass', 'ra', 'chi_eff', 'phi_jl', 'mass_ratio', 'phi_12', 'a_2', 'tilt_1', 'chirp_mass_source', 'mass_1_source', 'mass_1', 'redshift'];
