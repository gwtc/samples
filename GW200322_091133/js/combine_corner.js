...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'phi_jl', 'theta_jn', 'a_1', 'mass_1_source', 'mass_ratio', 'dec', 'luminosity_distance', 'tilt_1', 'ra', 'psi', 'chirp_mass', 'geocent_time', 'chirp_mass_source', 'a_2', 'tilt_2', 'phase', 'total_mass', 'mass_1', 'chi_p', 'phi_12', 'mass_2_source', 'chi_eff', 'mass_2', 'redshift'];
    list['C01:IMRPhenomXPHM'] = ['a_1', 'a_2', 'chi_eff', 'chi_p', 'chirp_mass', 'dec', 'geocent_time', 'luminosity_distance', 'mass_1', 'mass_2', 'mass_ratio', 'phase', 'phi_12', 'phi_jl', 'psi', 'ra', 'theta_jn', 'tilt_1', 'tilt_2', 'total_mass', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'redshift'];
