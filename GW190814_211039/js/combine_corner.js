...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['mass_ratio', 'total_mass', 'mass_2_source', 'total_mass_source', 'psi', 'phi_jl', 'a_2', 'chirp_mass_source', 'ra', 'tilt_2', 'mass_2', 'luminosity_distance', 'a_1', 'phase', 'tilt_1', 'mass_1', 'chi_p', 'geocent_time', 'dec', 'phi_12', 'chirp_mass', 'mass_1_source', 'chi_eff', 'theta_jn', 'redshift'];
