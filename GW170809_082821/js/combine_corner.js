...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass', 'mass_2', 'tilt_1', 'a_2', 'dec', 'a_1', 'psi', 'chi_p', 'mass_ratio', 'phi_jl', 'ra', 'chirp_mass', 'mass_2_source', 'luminosity_distance', 'geocent_time', 'mass_1', 'mass_1_source', 'theta_jn', 'total_mass_source', 'chi_eff', 'chirp_mass_source', 'phase', 'phi_12', 'tilt_2', 'redshift'];
