...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:IMRPhenomPv2_NRTidal:LowSpin'] = ['chirp_mass', 'mass_ratio', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'geocent_time', 'luminosity_distance', 'total_mass', 'mass_1', 'mass_2', 'ra', 'dec', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'redshift'];
    list['C01:IMRPhenomPv2_NRTidal:HighSpin'] = ['chirp_mass', 'mass_ratio', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'geocent_time', 'luminosity_distance', 'total_mass', 'mass_1', 'mass_2', 'ra', 'dec', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'redshift'];
    ...
    var data = {}
    data['C01:IMRPhenomPv2_NRTidal:LowSpin'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['C01:IMRPhenomPv2_NRTidal:HighSpin'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
