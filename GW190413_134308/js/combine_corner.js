...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['a_2', 'phase', 'total_mass', 'chi_eff', 'mass_1', 'phi_12', 'luminosity_distance', 'ra', 'psi', 'a_1', 'mass_1_source', 'tilt_2', 'chi_p', 'mass_2', 'theta_jn', 'total_mass_source', 'chirp_mass_source', 'tilt_1', 'chirp_mass', 'phi_jl', 'geocent_time', 'dec', 'mass_2_source', 'mass_ratio', 'redshift'];
