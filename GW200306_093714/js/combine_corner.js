...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_1', 'mass_ratio', 'dec', 'phi_jl', 'geocent_time', 'theta_jn', 'chi_p', 'tilt_1', 'ra', 'chirp_mass_source', 'a_2', 'total_mass', 'tilt_2', 'phase', 'chi_eff', 'mass_2_source', 'luminosity_distance', 'a_1', 'total_mass_source', 'phi_12', 'chirp_mass', 'mass_2', 'psi', 'mass_1_source', 'redshift'];
