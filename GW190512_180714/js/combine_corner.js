...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_2_source', 'ra', 'phase', 'geocent_time', 'a_2', 'dec', 'luminosity_distance', 'chirp_mass', 'tilt_1', 'chi_eff', 'chi_p', 'mass_1', 'tilt_2', 'mass_2', 'chirp_mass_source', 'total_mass', 'total_mass_source', 'psi', 'phi_12', 'theta_jn', 'mass_ratio', 'a_1', 'phi_jl', 'mass_1_source', 'redshift'];
