...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_ratio', 'chi_p', 'tilt_2', 'tilt_1', 'luminosity_distance', 'mass_2', 'total_mass_source', 'phase', 'phi_jl', 'a_1', 'mass_2_source', 'dec', 'a_2', 'geocent_time', 'mass_1_source', 'chirp_mass', 'psi', 'chi_eff', 'total_mass', 'chirp_mass_source', 'theta_jn', 'mass_1', 'phi_12', 'ra', 'redshift'];
