...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_2_source', 'dec', 'mass_ratio', 'geocent_time', 'total_mass_source', 'tilt_2', 'phi_jl', 'phase', 'chi_eff', 'theta_jn', 'chirp_mass', 'total_mass', 'psi', 'chi_p', 'a_1', 'a_2', 'phi_12', 'luminosity_distance', 'mass_2', 'chirp_mass_source', 'mass_1', 'tilt_1', 'mass_1_source', 'ra', 'redshift'];
    list['C01:IMRPhenomXPHM'] = ['phase', 'phi_12', 'phi_jl', 'mass_ratio', 'geocent_time', 'ra', 'dec', 'luminosity_distance', 'psi', 'chirp_mass', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'theta_jn', 'mass_1', 'mass_2', 'total_mass', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'chi_p', 'chi_eff', 'redshift'];
