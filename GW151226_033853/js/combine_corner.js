...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['geocent_time', 'mass_2_source', 'phi_12', 'phase', 'chi_eff', 'chirp_mass_source', 'theta_jn', 'mass_1_source', 'psi', 'total_mass_source', 'mass_ratio', 'chirp_mass', 'tilt_2', 'a_1', 'luminosity_distance', 'dec', 'tilt_1', 'mass_2', 'ra', 'phi_jl', 'chi_p', 'total_mass', 'mass_1', 'a_2', 'redshift'];
