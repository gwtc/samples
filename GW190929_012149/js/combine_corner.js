...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['psi', 'geocent_time', 'phi_jl', 'mass_2_source', 'chi_eff', 'luminosity_distance', 'chirp_mass', 'mass_1', 'theta_jn', 'phi_12', 'total_mass', 'mass_2', 'mass_1_source', 'tilt_2', 'a_1', 'tilt_1', 'ra', 'mass_ratio', 'chi_p', 'chirp_mass_source', 'total_mass_source', 'a_2', 'phase', 'dec', 'redshift'];
