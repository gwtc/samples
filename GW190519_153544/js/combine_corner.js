...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'chirp_mass', 'mass_ratio', 'mass_1_source', 'phase', 'chi_eff', 'tilt_2', 'mass_2', 'geocent_time', 'chirp_mass_source', 'psi', 'ra', 'dec', 'theta_jn', 'a_2', 'chi_p', 'phi_jl', 'luminosity_distance', 'total_mass', 'mass_2_source', 'phi_12', 'a_1', 'tilt_1', 'mass_1', 'redshift'];
