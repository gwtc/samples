...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_2_source', 'ra', 'chirp_mass_source', 'luminosity_distance', 'tilt_1', 'chirp_mass', 'phase', 'psi', 'chi_eff', 'dec', 'phi_jl', 'theta_jn', 'a_1', 'a_2', 'chi_p', 'total_mass', 'phi_12', 'total_mass_source', 'geocent_time', 'mass_2', 'mass_1_source', 'tilt_2', 'mass_1', 'mass_ratio', 'redshift'];
