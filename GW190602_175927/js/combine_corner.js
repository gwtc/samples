...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['ra', 'phi_12', 'theta_jn', 'phi_jl', 'chi_p', 'tilt_1', 'dec', 'mass_2', 'chi_eff', 'geocent_time', 'chirp_mass_source', 'mass_2_source', 'mass_1', 'luminosity_distance', 'mass_ratio', 'a_1', 'a_2', 'mass_1_source', 'phase', 'tilt_2', 'total_mass', 'psi', 'total_mass_source', 'chirp_mass', 'redshift'];
