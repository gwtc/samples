...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass', 'tilt_2', 'ra', 'mass_ratio', 'psi', 'dec', 'luminosity_distance', 'chi_eff', 'geocent_time', 'mass_2', 'phase', 'tilt_1', 'mass_1_source', 'theta_jn', 'mass_2_source', 'a_1', 'total_mass_source', 'mass_1', 'chirp_mass', 'chirp_mass_source', 'phi_12', 'chi_p', 'a_2', 'phi_jl', 'redshift'];
