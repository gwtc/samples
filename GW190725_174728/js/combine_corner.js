...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['a_2', 'mass_1_source', 'chirp_mass_source', 'mass_1', 'tilt_1', 'chi_p', 'total_mass', 'luminosity_distance', 'chirp_mass', 'phase', 'phi_jl', 'theta_jn', 'total_mass_source', 'tilt_2', 'mass_2_source', 'ra', 'phi_12', 'a_1', 'mass_2', 'mass_ratio', 'psi', 'geocent_time', 'dec', 'chi_eff', 'redshift'];
