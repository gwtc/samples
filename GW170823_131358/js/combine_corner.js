...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'luminosity_distance', 'mass_2', 'phi_12', 'psi', 'mass_ratio', 'tilt_2', 'a_2', 'chirp_mass', 'mass_2_source', 'dec', 'mass_1_source', 'phi_jl', 'a_1', 'phase', 'chirp_mass_source', 'theta_jn', 'mass_1', 'total_mass', 'chi_eff', 'chi_p', 'ra', 'tilt_1', 'geocent_time', 'redshift'];
