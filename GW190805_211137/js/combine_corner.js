...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['theta_jn', 'chirp_mass', 'psi', 'total_mass_source', 'chi_eff', 'dec', 'geocent_time', 'phi_12', 'ra', 'phi_jl', 'phase', 'a_2', 'luminosity_distance', 'a_1', 'total_mass', 'mass_2_source', 'tilt_1', 'mass_ratio', 'chi_p', 'chirp_mass_source', 'mass_2', 'mass_1', 'tilt_2', 'mass_1_source', 'redshift'];
