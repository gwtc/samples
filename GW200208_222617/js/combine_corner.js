...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['a_1', 'mass_ratio', 'tilt_2', 'mass_1', 'mass_2_source', 'dec', 'mass_2', 'theta_jn', 'chirp_mass', 'phi_jl', 'chi_p', 'phase', 'luminosity_distance', 'ra', 'total_mass', 'total_mass_source', 'psi', 'geocent_time', 'phi_12', 'chirp_mass_source', 'mass_1_source', 'chi_eff', 'tilt_1', 'a_2', 'redshift'];
