...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['dec', 'mass_1', 'mass_1_source', 'mass_2_source', 'psi', 'tilt_2', 'phi_12', 'chi_p', 'mass_2', 'phi_jl', 'chi_eff', 'a_1', 'total_mass_source', 'luminosity_distance', 'mass_ratio', 'geocent_time', 'theta_jn', 'ra', 'phase', 'a_2', 'tilt_1', 'chirp_mass_source', 'chirp_mass', 'total_mass', 'redshift'];
