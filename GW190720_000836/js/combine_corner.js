...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['tilt_2', 'chirp_mass', 'a_1', 'geocent_time', 'a_2', 'dec', 'total_mass', 'mass_1', 'luminosity_distance', 'mass_1_source', 'mass_ratio', 'psi', 'phase', 'phi_jl', 'chirp_mass_source', 'mass_2_source', 'phi_12', 'chi_eff', 'theta_jn', 'ra', 'tilt_1', 'mass_2', 'total_mass_source', 'chi_p', 'redshift'];
