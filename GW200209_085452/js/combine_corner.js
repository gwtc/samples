...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['luminosity_distance', 'total_mass_source', 'mass_2_source', 'mass_ratio', 'tilt_1', 'tilt_2', 'geocent_time', 'mass_2', 'theta_jn', 'mass_1_source', 'a_2', 'a_1', 'chi_p', 'total_mass', 'mass_1', 'dec', 'psi', 'phi_jl', 'phi_12', 'chirp_mass_source', 'chirp_mass', 'ra', 'chi_eff', 'phase', 'redshift'];
