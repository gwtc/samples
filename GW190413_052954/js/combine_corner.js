...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['phi_12', 'chi_eff', 'phase', 'a_2', 'mass_ratio', 'mass_2', 'phi_jl', 'geocent_time', 'ra', 'dec', 'total_mass_source', 'mass_2_source', 'chi_p', 'theta_jn', 'chirp_mass_source', 'total_mass', 'mass_1_source', 'luminosity_distance', 'a_1', 'tilt_2', 'psi', 'tilt_1', 'chirp_mass', 'mass_1', 'redshift'];
