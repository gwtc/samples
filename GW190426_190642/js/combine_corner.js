...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['mass_2_source', 'tilt_1', 'chirp_mass_source', 'chirp_mass', 'tilt_2', 'psi', 'chi_p', 'a_2', 'a_1', 'mass_1_source', 'phi_12', 'mass_2', 'mass_ratio', 'dec', 'ra', 'geocent_time', 'mass_1', 'total_mass', 'total_mass_source', 'phase', 'chi_eff', 'theta_jn', 'phi_jl', 'luminosity_distance', 'redshift'];
