...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['luminosity_distance', 'chirp_mass', 'chirp_mass_source', 'mass_ratio', 'total_mass', 'mass_2', 'mass_1_source', 'a_2', 'phi_jl', 'a_1', 'psi', 'mass_1', 'ra', 'geocent_time', 'phi_12', 'dec', 'theta_jn', 'phase', 'mass_2_source', 'chi_p', 'tilt_1', 'tilt_2', 'total_mass_source', 'chi_eff', 'redshift'];
