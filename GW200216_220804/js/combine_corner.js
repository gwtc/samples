...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_ratio', 'theta_jn', 'luminosity_distance', 'chi_eff', 'tilt_1', 'a_2', 'phi_jl', 'mass_1', 'tilt_2', 'psi', 'total_mass', 'mass_2', 'chirp_mass', 'ra', 'a_1', 'phi_12', 'mass_2_source', 'geocent_time', 'phase', 'total_mass_source', 'mass_1_source', 'chirp_mass_source', 'dec', 'chi_p', 'redshift'];
