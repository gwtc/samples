...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass', 'chirp_mass_source', 'mass_2', 'ra', 'chi_p', 'luminosity_distance', 'geocent_time', 'a_2', 'total_mass_source', 'chi_eff', 'theta_jn', 'dec', 'a_1', 'mass_2_source', 'chirp_mass', 'phi_jl', 'phi_12', 'mass_ratio', 'tilt_2', 'tilt_1', 'mass_1', 'mass_1_source', 'phase', 'psi', 'redshift'];
