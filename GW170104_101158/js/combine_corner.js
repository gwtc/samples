...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['tilt_1', 'dec', 'total_mass', 'phi_12', 'mass_1', 'mass_ratio', 'mass_2_source', 'mass_2', 'psi', 'ra', 'a_2', 'a_1', 'luminosity_distance', 'theta_jn', 'mass_1_source', 'chi_p', 'geocent_time', 'tilt_2', 'total_mass_source', 'chirp_mass', 'chirp_mass_source', 'phase', 'phi_jl', 'chi_eff', 'redshift'];
