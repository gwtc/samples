...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'chirp_mass', 'tilt_2', 'chi_eff', 'a_1', 'phi_jl', 'tilt_1', 'total_mass', 'a_2', 'mass_ratio', 'luminosity_distance', 'geocent_time', 'chirp_mass_source', 'mass_2_source', 'theta_jn', 'phase', 'chi_p', 'mass_1_source', 'mass_2', 'phi_12', 'psi', 'ra', 'mass_1', 'dec', 'redshift'];
