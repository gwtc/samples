...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_2_source', 'a_1', 'chi_eff', 'chirp_mass', 'mass_ratio', 'psi', 'dec', 'phase', 'total_mass', 'phi_12', 'chirp_mass_source', 'phi_jl', 'tilt_1', 'luminosity_distance', 'mass_1', 'total_mass_source', 'chi_p', 'a_2', 'theta_jn', 'geocent_time', 'mass_2', 'ra', 'mass_1_source', 'tilt_2', 'redshift'];
