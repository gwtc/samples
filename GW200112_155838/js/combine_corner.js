...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass_source', 'luminosity_distance', 'chirp_mass', 'phi_jl', 'mass_1', 'psi', 'mass_2', 'tilt_2', 'a_1', 'chirp_mass_source', 'mass_2_source', 'a_2', 'mass_1_source', 'mass_ratio', 'chi_eff', 'phase', 'theta_jn', 'chi_p', 'dec', 'phi_12', 'total_mass', 'geocent_time', 'ra', 'tilt_1', 'redshift'];
