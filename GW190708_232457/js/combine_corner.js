...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['luminosity_distance', 'chirp_mass_source', 'mass_1', 'psi', 'a_2', 'a_1', 'mass_2_source', 'chi_eff', 'tilt_2', 'phi_12', 'mass_ratio', 'mass_1_source', 'chirp_mass', 'phi_jl', 'tilt_1', 'phase', 'ra', 'theta_jn', 'geocent_time', 'dec', 'chi_p', 'total_mass', 'mass_2', 'total_mass_source', 'redshift'];
