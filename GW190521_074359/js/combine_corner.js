...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['ra', 'mass_2', 'a_2', 'chirp_mass_source', 'phase', 'chi_p', 'phi_12', 'total_mass', 'theta_jn', 'chirp_mass', 'mass_1', 'luminosity_distance', 'phi_jl', 'mass_2_source', 'a_1', 'tilt_1', 'total_mass_source', 'chi_eff', 'tilt_2', 'mass_ratio', 'psi', 'mass_1_source', 'geocent_time', 'dec', 'redshift'];
