...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['theta_jn', 'chi_p', 'dec', 'chi_eff', 'mass_1_source', 'phase', 'tilt_2', 'geocent_time', 'luminosity_distance', 'chirp_mass_source', 'tilt_1', 'mass_2_source', 'mass_2', 'psi', 'total_mass_source', 'mass_1', 'a_2', 'ra', 'a_1', 'chirp_mass', 'phi_jl', 'mass_ratio', 'phi_12', 'total_mass', 'redshift'];
