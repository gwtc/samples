...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['chirp_mass', 'a_2', 'dec', 'ra', 'mass_1', 'total_mass_source', 'phase', 'psi', 'tilt_2', 'mass_2_source', 'theta_jn', 'mass_1_source', 'tilt_1', 'chi_eff', 'phi_jl', 'mass_ratio', 'luminosity_distance', 'chirp_mass_source', 'total_mass', 'phi_12', 'chi_p', 'geocent_time', 'a_1', 'mass_2', 'redshift'];
