...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['a_1', 'a_2', 'ra', 'phase', 'total_mass_source', 'mass_ratio', 'chirp_mass', 'total_mass', 'mass_1', 'luminosity_distance', 'tilt_2', 'mass_1_source', 'mass_2', 'chirp_mass_source', 'geocent_time', 'theta_jn', 'chi_eff', 'phi_12', 'mass_2_source', 'phi_jl', 'psi', 'dec', 'chi_p', 'tilt_1', 'redshift'];
