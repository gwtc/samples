...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass', 'mass_2', 'total_mass_source', 'mass_ratio', 'chirp_mass_source', 'chi_eff', 'phi_jl', 'phi_12', 'chi_p', 'phase', 'geocent_time', 'mass_2_source', 'chirp_mass', 'mass_1_source', 'luminosity_distance', 'a_1', 'mass_1', 'ra', 'tilt_2', 'dec', 'theta_jn', 'psi', 'tilt_1', 'a_2', 'redshift'];
