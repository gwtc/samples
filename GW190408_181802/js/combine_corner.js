...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_2_source', 'a_1', 'mass_ratio', 'chi_p', 'tilt_1', 'chirp_mass', 'ra', 'mass_1_source', 'total_mass', 'phi_12', 'theta_jn', 'mass_1', 'psi', 'chirp_mass_source', 'phase', 'a_2', 'dec', 'geocent_time', 'chi_eff', 'tilt_2', 'phi_jl', 'mass_2', 'luminosity_distance', 'total_mass_source', 'redshift'];
