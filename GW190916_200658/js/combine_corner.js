...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['tilt_1', 'luminosity_distance', 'mass_2_source', 'geocent_time', 'mass_2', 'a_2', 'mass_1_source', 'theta_jn', 'chirp_mass', 'mass_1', 'total_mass_source', 'tilt_2', 'chi_p', 'total_mass', 'psi', 'a_1', 'dec', 'phi_jl', 'ra', 'phase', 'mass_ratio', 'chirp_mass_source', 'phi_12', 'chi_eff', 'redshift'];
