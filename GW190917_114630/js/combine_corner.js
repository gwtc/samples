...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['mass_1', 'dec', 'chirp_mass', 'mass_ratio', 'tilt_2', 'chirp_mass_source', 'geocent_time', 'chi_p', 'luminosity_distance', 'phi_12', 'total_mass_source', 'total_mass', 'phi_jl', 'mass_2_source', 'mass_1_source', 'chi_eff', 'a_2', 'a_1', 'psi', 'phase', 'theta_jn', 'ra', 'mass_2', 'tilt_1', 'redshift'];
