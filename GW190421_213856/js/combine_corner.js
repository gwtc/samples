...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['chi_eff', 'a_2', 'phi_12', 'chi_p', 'phi_jl', 'tilt_1', 'tilt_2', 'a_1', 'chirp_mass', 'mass_ratio', 'psi', 'luminosity_distance', 'dec', 'mass_2_source', 'total_mass_source', 'mass_2', 'mass_1_source', 'theta_jn', 'total_mass', 'geocent_time', 'phase', 'mass_1', 'chirp_mass_source', 'ra', 'redshift'];
