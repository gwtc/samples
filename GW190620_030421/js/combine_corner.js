...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['luminosity_distance', 'total_mass_source', 'mass_1', 'psi', 'mass_2_source', 'a_1', 'phase', 'total_mass', 'chi_eff', 'phi_12', 'chirp_mass_source', 'tilt_2', 'dec', 'a_2', 'mass_1_source', 'geocent_time', 'chi_p', 'mass_2', 'theta_jn', 'chirp_mass', 'tilt_1', 'ra', 'mass_ratio', 'phi_jl', 'redshift'];
