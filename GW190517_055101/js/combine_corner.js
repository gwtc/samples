...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:SEOBNRv4PHM'] = ['mass_1', 'mass_2', 'chirp_mass', 'ra', 'dec', 'geocent_time', 'phase', 'psi', 'luminosity_distance', 'total_mass', 'mass_ratio', 'chi_eff', 'chi_p', 'tilt_1', 'tilt_2', 'phi_12', 'theta_jn', 'phi_jl', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'a_1', 'a_2', 'redshift'];
    list['C01:Mixed'] = ['phi_jl', 'mass_1', 'chirp_mass_source', 'phase', 'chi_p', 'geocent_time', 'theta_jn', 'tilt_2', 'chirp_mass', 'a_1', 'mass_2_source', 'total_mass_source', 'ra', 'psi', 'dec', 'luminosity_distance', 'phi_12', 'a_2', 'mass_2', 'chi_eff', 'mass_ratio', 'mass_1_source', 'total_mass', 'tilt_1', 'redshift'];
    list['C01:IMRPhenomXPHM'] = ['chirp_mass', 'mass_ratio', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'theta_jn', 'psi', 'phase', 'luminosity_distance', 'geocent_time', 'total_mass', 'mass_1', 'mass_2', 'ra', 'dec', 'chi_eff', 'chi_p', 'mass_1_source', 'mass_2_source', 'total_mass_source', 'chirp_mass_source', 'redshift'];
