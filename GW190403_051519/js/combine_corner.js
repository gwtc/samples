...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['chirp_mass', 'mass_1_source', 'luminosity_distance', 'mass_ratio', 'chi_p', 'total_mass', 'mass_1', 'chi_eff', 'ra', 'total_mass_source', 'chirp_mass_source', 'mass_2_source', 'phase', 'a_2', 'geocent_time', 'tilt_2', 'theta_jn', 'psi', 'phi_12', 'dec', 'mass_2', 'a_1', 'phi_jl', 'tilt_1', 'redshift'];
