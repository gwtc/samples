...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['dec', 'mass_1', 'a_1', 'phase', 'chirp_mass', 'chi_eff', 'a_2', 'mass_2', 'mass_1_source', 'theta_jn', 'chi_p', 'mass_ratio', 'phi_12', 'ra', 'luminosity_distance', 'total_mass', 'phi_jl', 'chirp_mass_source', 'total_mass_source', 'tilt_2', 'psi', 'mass_2_source', 'geocent_time', 'tilt_1', 'redshift'];
