...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['total_mass', 'luminosity_distance', 'mass_2', 'chirp_mass_source', 'total_mass_source', 'dec', 'mass_1_source', 'a_1', 'phi_12', 'geocent_time', 'theta_jn', 'tilt_2', 'chi_eff', 'phi_jl', 'chirp_mass', 'psi', 'tilt_1', 'phase', 'mass_1', 'a_2', 'mass_ratio', 'ra', 'chi_p', 'mass_2_source', 'redshift'];
