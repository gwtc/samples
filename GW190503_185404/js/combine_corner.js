...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['theta_jn', 'dec', 'chi_p', 'mass_ratio', 'phi_jl', 'tilt_1', 'mass_2', 'tilt_2', 'total_mass_source', 'a_1', 'psi', 'mass_2_source', 'ra', 'phase', 'chirp_mass_source', 'geocent_time', 'total_mass', 'luminosity_distance', 'chirp_mass', 'mass_1', 'chi_eff', 'mass_1_source', 'a_2', 'phi_12', 'redshift'];
