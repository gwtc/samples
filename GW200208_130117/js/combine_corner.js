...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['mass_ratio', 'psi', 'mass_2', 'luminosity_distance', 'geocent_time', 'phi_12', 'tilt_2', 'dec', 'chi_p', 'mass_2_source', 'tilt_1', 'theta_jn', 'chi_eff', 'a_1', 'phase', 'chirp_mass', 'phi_jl', 'ra', 'mass_1', 'a_2', 'total_mass', 'chirp_mass_source', 'total_mass_source', 'mass_1_source', 'redshift'];
