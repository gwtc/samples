...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['C01:Mixed'] = ['ra', 'theta_jn', 'chi_p', 'mass_1', 'tilt_1', 'phase', 'phi_jl', 'chirp_mass_source', 'a_2', 'mass_ratio', 'chi_eff', 'mass_2', 'total_mass', 'mass_1_source', 'mass_2_source', 'dec', 'a_1', 'tilt_2', 'psi', 'luminosity_distance', 'phi_12', 'total_mass_source', 'chirp_mass', 'geocent_time', 'redshift'];
