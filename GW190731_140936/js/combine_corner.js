...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['phi_12', 'total_mass_source', 'mass_2_source', 'theta_jn', 'chi_p', 'mass_ratio', 'chirp_mass', 'chirp_mass_source', 'mass_1_source', 'dec', 'psi', 'luminosity_distance', 'mass_1', 'tilt_1', 'a_1', 'tilt_2', 'total_mass', 'ra', 'a_2', 'chi_eff', 'mass_2', 'phase', 'phi_jl', 'geocent_time', 'redshift'];
