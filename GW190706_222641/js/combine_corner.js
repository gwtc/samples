...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['dec', 'mass_1', 'phase', 'tilt_1', 'theta_jn', 'mass_2_source', 'chi_eff', 'ra', 'total_mass_source', 'mass_1_source', 'luminosity_distance', 'mass_2', 'phi_jl', 'chirp_mass', 'mass_ratio', 'a_1', 'total_mass', 'chirp_mass_source', 'geocent_time', 'tilt_2', 'chi_p', 'psi', 'a_2', 'phi_12', 'redshift'];
