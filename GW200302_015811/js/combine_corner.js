...
function getImagePortion(c, imgObj, array, label){
    ...
    list['C01:Mixed'] = ['a_1', 'phi_12', 'mass_2', 'mass_ratio', 'tilt_2', 'luminosity_distance', 'total_mass_source', 'psi', 'phase', 'chirp_mass', 'tilt_1', 'chi_eff', 'ra', 'chi_p', 'geocent_time', 'a_2', 'mass_2_source', 'mass_1_source', 'theta_jn', 'chirp_mass_source', 'total_mass', 'phi_jl', 'dec', 'mass_1', 'redshift'];
